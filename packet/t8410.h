...
///////////////////////////////////////////////////////////////////////////////////////////////////
// API전용주식챠트(일주월년)(t8410) ( attr,block,headtype=A )
#pragma pack( push, 1 )

#define NAME_t8410     "t8410"

// 기본입력                       
typedef struct _t8410InBlock
{
...
} t8410InBlock, *LPt8410InBlock;
#define NAME_t8410InBlock     "t8410InBlock"

// 출력                           
typedef struct _t8410OutBlock
{
    char    shcode              [   6];    char    _shcode              ;    // [string,    6] 단축코드                        StartPos 0, Length 6
...
} t8410OutBlock, *LPt8410OutBlock;
#define NAME_t8410OutBlock     "t8410OutBlock"

// 출력1                          , occurs
typedef struct _t8410OutBlock1
{
...
} t8410OutBlock1, *LPt8410OutBlock1;
#define NAME_t8410OutBlock1     "t8410OutBlock1"
